<?php
class Advertiser_Models_Forms_Registration extends Zend_Form {
	/**
	...
	function __construct() {
		...
		$this->setMethod('POST');
		$this->setAction('/advertiser/register');
		...
		$this->addElements(array($username,$password, $email,$paymentEmail,$countries,$submit));
	}
